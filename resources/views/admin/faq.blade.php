                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin_faq_create')}}">Faq Create</a></li>
                                </ol>
                            </div>
                                  ...
                                  <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                      ...
                                      <tbody>
                                        @foreach ($datalist as $data)
                                          <tr>
                                              <td style="width: 50px">{{$data->position}}</td>
                                              <td style="width: 100px">{{$data->questions}}</td>
                                              <td style="width: 100px">{!! $data->answer !!}</td>
                                              <td style="width: 100px">{{$data->status}}</td>
                                              <td style="width: 100px">
                                                  <a class="btn btn-outline-secondary btn-sm edit" title="Edit" href="{{route('admin_faq_edit', $data->id)}}">
                                                      <i class="fas fa-pencil-alt"></i>
                                                  </a>
                                              </td>
                                              <td style="width: 100px">
                                                  <a class="btn btn-outline-secondary btn-sm delete" title="Delete" href="{{route('admin_faq_delete', $data->id)}}" onclick= "return confirm('Delete ! Are you sure')">
