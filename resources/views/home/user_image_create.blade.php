          ...
          <div class="container"><br>
                      ...
                      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                          ...
                          <div class="page-title-right">
                              <ol class="breadcrumb m-0">
                                  <li class="breadcrumb-item active"><a href="{{route('user_products')}}">Product List</a></li>
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="card">
                          <div class="card-body">
                              <form action="{{route('user_image_store', $images->id)}}" method="post" enctype="multipart/form-data">
                                  @csrf
                                          ...
                                          @foreach ($image as $img)
                                              <tr>
                                                  ...
                                                  <td style="width: 100px">
                                                      <a class="btn btn-outline-secondary btn-sm delete" title="Delete" href="{{route('user_image_delete', [$img->id, $images->id])}}" onclick="return confirm('Recort will be Delete ! Are you sure')">
